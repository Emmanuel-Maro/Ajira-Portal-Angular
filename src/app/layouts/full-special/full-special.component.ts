...
@Component({
  selector: 'app-full-special',
  templateUrl: './full-special.component.html',
  styleUrls: ['./full-special.component.css']
})
export class FullSpecialComponent implements OnDestroy {
